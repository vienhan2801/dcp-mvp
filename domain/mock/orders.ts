...
export const mockOrders: Order[] = [
  ...
  // ── ORDER 4: Chờ phê duyệt (pending_approval) — mới validate xong ──
  {
    id: "ORD-2026-004",
    contractId: "CTR-2026-001",
    hospitalName: "BV ĐH Y Dược TP.HCM",
    supplierName: "PhytoPharma",
    orderDate: "2026-05-14",
    requestedDeliveryDate: "2026-05-21",
    deliveryLocation: "Kho dược phẩm tầng 1, Tòa nhà A, 215 Hồng Bàng, Q.5, TP.HCM",
    status: "pending_approval",
    note: "Đơn tuần 21 — đã auto-validate thành công, chờ NPP phê duyệt",
    totalRequestedAmount: 480_000_000,
    totalConfirmedAmount: 0,
    lines: [
      {
        id: "LINE-004-1",
