...
const ACTION_ICON_COLORS: Record<EvidenceActionType, string> = {
  ...
  order_pending_approval:     "bg-yellow-100 text-yellow-700",
  order_approved:             "bg-emerald-100 text-emerald-700",
  delivery_updated:           "bg-purple-100 text-purple-700",
  receipt_confirmed:          "bg-[#024430]/10 text-[#024430]",
  issue_reported:             "bg-red-100 text-red-700",
  issue_resolved:             "bg-teal-100 text-teal-700",
  payment_updated:            "bg-indigo-100 text-indigo-700",
  message_sent:               "bg-gray-100 text-gray-700",
  contract_approved:          "bg-emerald-100 text-emerald-700",
  contract_amended:           "bg-violet-100 text-violet-700",
  tender_imported:            "bg-orange-100 text-orange-700",
  tender_standardized:        "bg-cyan-100 text-cyan-700",
  drug_created:               "bg-pink-100 text-pink-700",
  drug_updated:               "bg-rose-100 text-rose-700",
};
